    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-blue-300 via-sky-500 to-blue-800 text-white font-inter">
      <div className="text-center mb-12 max-w-6xl w-full">
        <h1
          className="text-5xl md:text-6xl font-extrabold mb-4 leading-tight
                       bg-gradient-to-r from-pink-700 via-blue-400 via-green-400 to-purple-500 bg-clip-text text-transparent
                       drop-shadow-[0_0_3px_rgb(0,0,0)] md:drop-shadow-[0_0_4px_rgb(0,0,0)]"
        >
          Welcome to the World of <br /> Fantastical Pets!{" "}
        </h1>
        <p className="text-3xl md:text-4xl opacity-90 text-purple-700">
      ...
      <div className="card bg-white bg-opacity-10 p-6 md:p-10 rounded-2xl shadow-2xl backdrop-blur-sm max-w-5xl w-full mb-12 border border-blue-400">
        ...
        <section className="flex flex-wrap justify-center gap-8 mb-8">
          <div className="card compact bg-white bg-opacity-20 rounded-xl shadow-lg border border-blue-300 p-4 flex flex-col items-center">
      ...
      <div className="flex flex-col md:flex-row justify-center items-stretch gap-8 mb-12 w-full px-4 md:max-w-none">
        ...
        <div className="card bg-white bg-opacity-10 p-6 md:p-10 rounded-2xl shadow-2xl backdrop-blur-sm w-full md:flex-1">
          ...
          <p className="text-lg md:text-xl opacity-90 max-w-md mx-auto text-black">
            Or, If You Like Surprises, Our Magical AI Can Invent A Cute Name And
            A Silly Description Just For You!
          </p>
        </div>
      </div>{" "}
